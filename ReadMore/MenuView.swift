...
struct MenuView: View {
    var body: some View {
        VStack {
            ...
            VStack(spacing: 16) {
                Text("Monthly Reading Challenge: 28% Complete").font(.caption)
                ...
                MenuRow(title: "Payment", icon: "creditcard")
            ...
            .overlay(
                AvatarView(showProfile: .constant(false), size: CGSize(width: 60, height: 60))
                .offset(y: -150)
            )
        }
        .padding(.bottom, 30)
